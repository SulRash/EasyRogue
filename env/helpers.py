...
def create_train_model(algo: str, path_to_save: str, total_timesteps: int, env: Env, mlp: bool = False, reward_callback: int = 0):
    """
    ...
    if reward_callback:
        ...
        eval_callback = EvalCallback(env, verbose=1, n_eval_episodes=5, best_model_save_path="Environment\\BestModels\\", callback_on_new_best=callback_on_best)
    else:
