...
from src.entities.entity import Entity, AIFighter, Fighter, Item, Actor
...
class Engine:
    ...
    def __init__(self, player: Fighter, seed: int = 0, fixed_seed: bool = False) -> None:
        """
    ...
    def next_level(self) -> None:
        ...
        min_rooms, max_rooms, min_room_size, max_room_size, num_enemies, num_potions = self.calculate_paramaters()
    ...
    def calculate_paramaters(self) -> None:
        """
