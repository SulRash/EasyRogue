...
from env.helpers import next_available, create_train_model, load_model, test_model
...
def main():
    ...
    if mode:
        ...
        env = EasyRogue(seed=seed, to_image=to_image, fixed_seed=fixed_seed, perfect_info=perfect_info)
